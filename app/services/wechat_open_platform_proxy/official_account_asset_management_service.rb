module WechatOpenPlatformProxy
  class OfficialAccountAssetManagementService
    ...
    def upload_temporary_asset(asset_params)
      ...
      resp = Faraday.post "https://api.weixin.qq.com/cgi-bin/media/upload?access_token=#{OfficialAccountCacheStore.new(official_account).fetch_access_token}", asset_params.to_json
