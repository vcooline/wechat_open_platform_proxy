module WechatOpenPlatformProxy
  class OfficialAccountShortUrlService
    ...
    def perform(url_params)
      Rails.logger.info "OfficialAccountShortUrlService perform reqt: #{url_params.to_json}"
      ...
      Rails.logger.info "OfficialAccountShortUrlService perform resp: #{resp.body.squish}"
