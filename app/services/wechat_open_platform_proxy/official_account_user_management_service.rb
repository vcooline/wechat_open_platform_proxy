module WechatOpenPlatformProxy
  class OfficialAccountUserManagementService
    ...
    def user_list(next_openid=nil)
      ...
      Rails.logger.info "OfficialAccountUserManagementService user list resp: #{resp.body}"
    ...
    def user_info(open_id)
      ...
      Rails.logger.info "OfficialAccountUserManagementService user info resp: #{resp.body}"
